...
namespace SharpMedia.Scene.Rendering.Transform
{

    /// <summary>
    /// A transform operation. It transformed the incoming position and optional normal
    /// to transformed versions.
    /// </summary>
    public class TransformOperation : IOperation
    {
