...
namespace SharpMedia.Scene.PostEffects
{
    ...
    /// <summary>
    /// A post effect operation allows certain effects to plug themelves and do some processing on
    /// colour before it is written to render target.
    /// </summary>
    public class PostEffectOperation : IOperation
    {
