...
namespace SharpMedia.Scene.Animation
{
    ...
    /// <summary>
    /// Animation operation is given array of IAnimation (usually only one) class and affects
    /// how position and normal are transformed.
    /// </summary>
    /// <remarks>
    /// Operation is given position (Floatx4) and optional normal (Floatx3) and returnes transformed
    /// position and (optional) normal.
    /// </remarks>
    public class AnimationOperation : IOperation
    {
