...
// using template 'Cylindricalf. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math
{
    ...
    /// </summary>
    [Serializable]
    public struct Cylindricalf : IEquatable<Cylindricalf>, IComparable, IComparable<Cylindricalf>
    {
        ...
        public Vector3f Cartesian
        {
            get
            {
                return new Vector3f(Polar.Cartesian, Z);
            }
            set
            {
                Polar.Cartesian = new Vector2f(value.X, value.Y);
                Z = value.Z;
            }
        }
        ...
        {
            if (obj is Cylindricalf)
            {
                return this == (Cylindricalf)obj;
            }
            return false;
        }
        ...
        public static bool operator ==(Cylindricalf c1, Cylindricalf c2)
        {
        ...
        #region IEquatable<Cylindricalf> Members

        public bool Equals(Cylindricalf other)
        {
            return this == other;
        }
        ...
        public int CompareTo(object obj)
        {
            if (obj is Cylindricalf)
            {
                return CompareTo((Cylindricalf)obj);
            }
        ...
        #region IComparable<Cylindricalf> Members

        public int CompareTo(Cylindricalf other)
        {
    ...
    [TestSuite]
    internal class Test_Cylindricalf
    {
        ...
        public void Conversion()
        {
            ...
            Cylindricalf c = v.Cylindrical;
            Assert.IsTrue(Vector3f.NearEqual(v, c.Cartesian));
