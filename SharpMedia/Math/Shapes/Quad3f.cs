...
// using template 'Quad3f. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math.Shapes
{
    ...
    public class Quad3f :
        ...
        IEquatable<Quad3f>, IComparable<Quad3f>,
        IEnumerable<Vector3f>, ICloneable<Quad3f>
        //#ifdef 3D
        ...
        //#endif
    {
        ...
        public Quad3f(Vector3f p0, Vector3f p1,
        ...
        {
            if (obj is Quad3f) return this.Equals((Quad3f)obj);
            return false;
        }
        ...
        public AABoxf BoundingAABox
        {
            get
            {
                return AABoxf.FromPoints(A, B, C, D);
            }
        }
        ...
        public Spheref BoundingSphere
        {
            get
            {
                return Spheref.FromPoints(A, B, C, D);
            }
        }
        ...
        #region IEquatable<Quad3f> Members

        public bool Equals(Quad3f other)
        {
            return Vector3f.NearEqual(A, other.A) &&
                   Vector3f.NearEqual(B, other.B) &&
                   Vector3f.NearEqual(C, other.C) &&
                   Vector3f.NearEqual(D, other.D);
        ...
        #region ICloneable<Quad3f> Members

        public Quad3f Clone()
        {
            return new Quad3f(A, B, C, D);
        }
        ...
        public int CompareTo(Quad3f other)
        {
    ...
    [TestSuite]
    internal class Quad3f_Test
    {
        /*
        [CorrectnessTest]
        public void Construction()
        {
            Quad3f q = new Quad3f(new Vector3f(0, 0, 0),
                                new Vector3f(1, 0, 0),
                                new Vector3f(1, 1, 0),
                                new Vector3f(0, 1, 0));

            Assert.AreEqual(q.A, new Vector3f(0, 0, 0));
            Assert.AreEqual(q.B, new Vector3f(1, 0, 0));
            Assert.AreEqual(q.C, new Vector3f(1, 1, 0));
            Assert.AreEqual(q.D, new Vector3f(0, 1, 0));
