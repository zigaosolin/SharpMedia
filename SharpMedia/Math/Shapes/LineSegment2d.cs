...
// using template 'LineSegment2d. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math.Shapes
{
    ...
    public sealed class LineSegment2d :
        ...
        IEquatable<LineSegment2d>, IComparable<LineSegment2d>,
        IEnumerable<Vector2d>, ICloneable<LineSegment2d>
        
    {
        ...
        public LineSegment2d(Vector2d from, Vector2d direction, double length)
        {
            this.A = from;
        ...
        public bool IsParallel([NotNull] LineSegment2d other)
        {
        ...
        public bool IsPerpendicular([NotNull] LineSegment2d other)
        {
            Vector2d special;
            //#ifdef 2D
        ...
        {
            if (obj is LineSegment2d) return this.Equals((LineSegment2d)obj);
            return false;
        }
        ...
        #region ICloneable<LineSegment2d> Members
        ...
        #region IEquatable<LineSegment2d> Members

        public bool Equals(LineSegment2d other)
        {
            if (Vector2d.NearEqual(this.A, other.A) &&
                Vector2d.NearEqual(this.B, other.B)) return true;
            return false;
        }
        #endregion
    ...
    [TestSuite]
    internal class LineSegment2d_Test
    {
        /*
        [CorrectnessTest]
        public void LineConstruction()
        {
            LineSegment2d line1 = new LineSegment2d(new Vector2d(0, 0, 0), new Vector2d(3, 3, 3));
            LineSegment2d line2 = new LineSegment2d(new Vector2d(0, 0, 0), new Vector2d(1, 1, 1), 3.0);
        ...
        {
            LineSegment2d line1 = new LineSegment2d(new Vector2d(0, 0, 0), new Vector2d(2, 0, 0));
        ...
        {
            LineSegment2d line = new LineSegment2d(new Vector2d(1, 0, 0), new Vector2d(2, 1, 0));
        ...
        {
            LineSegment2d line1 = new LineSegment2d(new Vector2d(0, 0, 0), new Vector2d(3, 0, 0));
            LineSegment2d line2 = new LineSegment2d(new Vector2d(1, -1, 0), new Vector2d(1, 5, 0));
