...
// using template 'OutlineCompound3d. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math.Shapes.Compounds
{
    ...
    [Serializable]
    public sealed class OutlineCompound3d :
        IArea3d, IOutline3d, ITransformable3d, ICloneable<OutlineCompound3d>
    {
        ...
        /// </summary>
        private class ContourBuilder : Storage.Builders.ILineBuilder3d
        {
            #region Private Members
            List<Vector3d[]> contours = new List<Vector3d[]>();
            #endregion
            ...
            void FinishContour()
            {
                ...
                Vector3d[] lastCountour = contours[contours.Count - 1];
            ...
            #region Builders.ILineBuilder3d Members
            ...
            public void AddLineStrip(bool linkFirstToLast, params Vector3d[] data)
            {
                ...
                if (linkFirstToLast)
                {
                    ...
                    Vector3d[] newData = new Vector3d[data.Length + 1];
                ...
                else
                {
                    ...
                    if (contours.Count > 0)
                    {
                        Vector3d[] lastContour = contours[contours.Count - 1];
                        ...
                        if (lastContour != null && Vector3d.NearEqual(lastContour[lastContour.Length - 1], data[0]))
                        {
                            // We append data.
                            Vector3d[] newData = new Vector3d[data.Length + lastContour.Length];
                            int i;
                            ...
                            if (Vector3d.NearEqual(newData[0], newData[newData.Length - 1])) FinishContour();
        ...
        /// <returns></returns>
        public IOutline3d this[uint index]
        {
            get
            {
        ...
        public uint[] StopIndices
        {
            get
            {
                ...
                {
                    if (Vector3d.NearEqual(outlines[i].Sample(0.0), outlines[i - 1].Sample(1.0)))
                    {
                        stops.Add((uint)(i - 1));
                    }
                }
        ...
        public OutlineCompound3d(params IOutline3d[] outlines)
        {
        ...
        {
            if (obj is OutlineCompound3d)
            {
                return this.Equals((OutlineCompound3d)obj);
            }
            return false;
        }
        ...
        public OutlineCompound3d Clone()
        {
            return new OutlineCompound3d(outlines);
        }
    ...
    [TestSuite]
    internal class Test_OutlineCompound3d
    {
        [CorrectnessTest]
