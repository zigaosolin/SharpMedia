...
// using template 'LineSegment3f. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math.Shapes
{
    ...
    /// </summary>
    [Serializable]
    public sealed class LineSegment3f :
        IOutline3f, IControlPoints3f, IContainsPoint3f, ITransformable3f,
        IEquatable<LineSegment3f>, IComparable<LineSegment3f>,
        IEnumerable<Vector3f>, ICloneable<LineSegment3f>
        //#ifdef 3D
        ...
        //#endif
    {
        ...
        public LineSegment3f(Vector3f from, Vector3f direction, float length)
        {
            this.A = from;
        ...
        public bool IsParallel([NotNull] LineSegment3f other)
        {
        ...
        public bool IsPerpendicular([NotNull] LineSegment3f other)
        {
            Vector3f special;
        ...
        {
            if (obj is LineSegment3f) return this.Equals((LineSegment3f)obj);
            return false;
        }
        ...
        public Spheref BoundingSphere
        {
            get
            {
                return new Spheref((float)0.5 * (A + B), (B - A).Length);
            }
        }
        ...
        #region ICloneable<LineSegment3f> Members

        public LineSegment3f Clone()
        {
            return new LineSegment3f(A, B);
        }

        #endregion

        #region IEquatable<LineSegment3f> Members

        public bool Equals(LineSegment3f other)
        {
            if (Vector3f.NearEqual(this.A, other.A) &&
                Vector3f.NearEqual(this.B, other.B)) return true;
            return false;
        }
        #endregion
    ...
    [TestSuite]
    internal class LineSegment3f_Test
    {
        /*
        [CorrectnessTest]
        public void LineConstruction()
        {
            LineSegment3f line1 = new LineSegment3f(new Vector3f(0, 0, 0), new Vector3f(3, 3, 3));
            LineSegment3f line2 = new LineSegment3f(new Vector3f(0, 0, 0), new Vector3f(1, 1, 1), 3.0);
        ...
        {
            LineSegment3f line1 = new LineSegment3f(new Vector3f(0, 0, 0), new Vector3f(2, 0, 0));
        ...
        {
            LineSegment3f line = new LineSegment3f(new Vector3f(1, 0, 0), new Vector3f(2, 1, 0));
        ...
        {
            LineSegment3f line1 = new LineSegment3f(new Vector3f(0, 0, 0), new Vector3f(3, 0, 0));
            LineSegment3f line2 = new LineSegment3f(new Vector3f(1, -1, 0), new Vector3f(1, 5, 0));
