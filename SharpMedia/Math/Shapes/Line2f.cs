...
// using template 'Line2f. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math.Shapes
{
    ...
    /// </summary>
    [Serializable]
    public sealed class Line2f :
        IOutline2f, IControlPoints2f, IContainsPoint2f, ITransformable2f,
        IEquatable<Line2f>, IComparable<Line2f>,
        IEnumerable<Vector2f>, ICloneable<Line2f>
    {
        ...
        public Line2f(Vector2f from, Vector2f direction, float length)
        {
            this.A = from;
        ...
        public bool IsParallel([NotNull] Line2f other)
        {
        ...
        {
            if (obj is Line2f) return this.Equals((Line2f)obj);
            return false;
        }
        ...
        #region ICloneable<Line2f> Members

        public Line2f Clone()
        {
            return new Line2f(A, B);
        }

        #endregion

        #region IEquatable<Line2f> Members

        public bool Equals(Line2f other)
        {
            if (Vector2f.NearEqual(this.Direction, other.Direction) &&
    ...
    [TestSuite]
    internal class Line2f_Test
    {
        /*
        [CorrectnessTest]
        public void LineConstruction()
        {
            Line2f line1 = new Line2f(new Vector2f(0, 0, 0), new Vector2f(3, 3, 3));
            Line2f line2 = new Line2f(new Vector2f(0, 0, 0), new Vector2f(1, 1, 1), 3.0);
        ...
        {
            Line2f line1 = new Line2f(new Vector2f(0, 0, 0), new Vector2f(2, 0, 0));
        ...
        {
            Line2f line = new Line2f(new Vector2f(1, 0, 0), new Vector2f(2, 1, 0));
        ...
        {
            Line2f line1 = new Line2f(new Vector2f(0, 0, 0), new Vector2f(3, 0, 0));
            Line2f line2 = new Line2f(new Vector2f(1, -1, 0), new Vector2f(1, 5, 0));
