...
// using template 'Polygon2d. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math.Shapes
{
    ...
    public sealed class Polygon2d :
        ...
        IEquatable<Polygon2d>, IComparable<Polygon2d>,
        IEnumerable<Vector2d>, ICloneable<Polygon2d>
    {
        ...
        void SplitLine(Vector2d v1, Vector2d v2, double resolution, List<Vector2d> data)
        {
        ...
        /// <returns></returns>
        public Vector2d this[uint index]
        {
            get
            {
        ...
        /// The bounding region.
        /// </summary>
        public Region2d BoundingRegion
        {
            get
            {
                return Region2d.MinMax(Points);
            }
        }
        ...
        /// <returns></returns>
        public Vector2d[] ConvertToList(double resolution)
        {
        ...
        /// <returns></returns>
        public Vector2d[] ConvertToList(double resolution, bool duplicateFirst)
        {
            Vector2d[] points = Points;

            if (resolution > 0.0)
            {
                List<Vector2d> list = new List<Vector2d>(Points.Length);
        ...
        /// <param name="resolution"></param>
        /// <param name="?"></param>
        public void TesselateOutline(float resolution, Algorithms.OutlineTesselation.TesselationOptionsd options,
        ...
        public Polygon2d(params Vector2d[] points)
        {
            this.Points = points;
        }
        ...
        public override bool Equals(object obj)
        {
            if (obj is Polygon2d)
            {
                return this.Equals((Polygon2d)obj);
            }
            return false;
        }
        ...
        {
            Vector2d[] points = this.ConvertToList(resolution);

            // We now tesselate points.
            List<Vector2d[]> polygons = new List<Vector2d[]>();
            polygons.Add(points);
        ...
        #region IEquatable<Polygon2d> Members

        public bool Equals(Polygon2d other)
        {
            for (int i = 0; i < Points.Length; i++)
            {
                if (!Vector2d.NearEqual(this.Points[i], other.Points[i])) return false;
            }
            return true;
        }
        ...
        {
            return new Polygon2d(Points.Clone() as Vector2d[]);
        }
