...
// using template 'LineStrip3d. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math.Shapes.Storage
{
    ...
    /// </remarks>
    [Serializable]
    public class LineStrip3d : ILineAccess3d, ILineBuilder3d
    {
        #region Private Members
        List<uint> startIndices = new List<uint>();
        List<Vector3d[]> strips = new List<Vector3d[]>();
        #endregion

        #region Private Methods

        private Vector3d[] Find(uint index, out uint inIndex)
        {
        ...
        public List<Vector3d[]> LineStrips
        {
            get { return strips; }
        }
        ...
        public LineSegment3d Get(uint index)
        {
        ...
        public void Get(uint index, [NotNull] LineSegment3d line)
        {
            throw new NotImplementedException();
        }
        ...
        public LineSegment3d[] Get(uint index, uint count)
        {
            throw new NotImplementedException();
        }
        ...
        public void Get(uint index, LineSegment3d[] lines)
        {
            throw new NotImplementedException();
        }
        ...
        public void AddLineStrip(bool linkFirstToLast, params Vector3d[] data)
        {
            ...
            Vector3d[] list = new Vector3d[linkFirstToLast ? data.Length + 1 : data.Length];
