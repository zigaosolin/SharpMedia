...
// using template 'TriangleSoup3f. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math.Shapes.Storage
{
    ...
    /// </remarks>
    [Serializable]
    public class TriangleSoup3f : ITriangleAccess3f, ITriangleBuilder3f
    {
        ...
        public TriangleSoup3f(bool indexed)
        {
            if (indexed)
            {
        ...
        public Triangle3f Get(uint index)
        {
            int idx = (int)index;
            if (IsIndexed)
            {
                return new Triangle3f(vertices[(int)indices[idx * 3]], vertices[(int)indices[idx * 3 + 1]],
                                     vertices[(int)indices[idx * 3 + 2]]);
            }
            else
            {
                return new Triangle3f(vertices[idx * 3], vertices[idx * 3 + 1], vertices[idx * 3 + 2]);
            }
        }
        ...
        public void Get(uint index, Triangle3f[] triangles)
        {
        ...
        #region ITriangleBuilder3f Members
