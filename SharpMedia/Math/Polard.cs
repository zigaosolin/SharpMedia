...
// using template 'Polard. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math
{
    ...
    /// </summary>
    [Serializable]
    public struct Polard : IComparable, IComparable<Polard>, IEquatable<Polard>
    {
        ...
        public static bool NearEqual(Polard p1, Polard p2)
        {
        ...
        /// <returns>Do the nearly equal.</returns>
        public static bool NearEqual(Polard p1, Polard p2, double eps)
        {
        ...
        {
            get { return new Vector2d(MathHelper.Cos(Phi) * R, MathHelper.Sin(Phi) * R); }
            set
            {
                R = value.Length;
                ...
                {
                    Phi = value.Y < 0.0 ? 
                        (double)(1.5 * global::System.Math.PI) : 
                        (double)(0.5 * global::System.Math.PI);
                }
            }
        }
        ...
        public static bool operator ==(Polard p1, Polard p2)
        {
        ...
        {
            if (obj.GetType() == this.GetType()) return (Polard)obj == this;
            return false;
        }
        ...
        public Polard(double phi, double r)
        {
            this.Phi = phi;
            this.R = r;
        }
        ...
        #region IEquatable<Polard> Members

        public bool Equals(Polard other)
        {
            return this == other;
        }
        ...
        #region IComparable<Polard> Members

        public int CompareTo(Polard other)
        {
        ...
        {
            if (obj.GetType() == this.GetType()) return CompareTo((Polard)obj);
            return -1;
        }
