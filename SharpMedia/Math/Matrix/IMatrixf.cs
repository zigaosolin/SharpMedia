...
// using template 'MatrixInterfacef. Do not modify this file directly, modify it from template source.
...
{
    /// <summary>
    /// Matrix specialisation to float underlaying type.
    /// </summary>
    public interface IMatrixf<T, T2> : IMatrixBase<T>
    {
        /// <summary>
        ...
        float this[uint row, uint column]
        {
            get;
            set;
        }
    ...
    /// </summary>
    public interface ISparseMatrixf<T, T2> : IMatrixf<T, T2>
    {
        /// <summary>
