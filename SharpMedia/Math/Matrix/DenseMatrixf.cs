...
// using template 'DenseMatrixf. Do not modify this file directly, modify it from template source.
...
namespace SharpMedia.Math.Matrix
{
    ...
    /// </summary>
    public sealed class DenseMatrixf : IMatrixf<DenseMatrixf, DenseMatrixf>
    {
        ...
        public Vectorf Row(uint index)
        {
            ...
            // We construct vector.
            Vectorf vector = new Vectorf((uint)elements.GetLength(1));
        ...
        public DenseMatrixf([NotNull] float[,] data)
        {
            elements = data;
        }
        ...
        public DenseMatrixf(uint rows, uint columns)
        {
        ...
        public float Min
        {
            get
            {
                if (elements.GetLength(0) == 0 || elements.GetLength(1) == 0) return float.NaN;
                float min = elements[0, 0];
                for (int i = 0; i < elements.GetLength(0); i++)
                {
                    for (int j = 0; j < elements.GetLength(1); j++)
                    {
        ...
        public float AbsMin
        {
            get
            {
                if (elements.GetLength(0) == 0 || elements.GetLength(1) == 0) return 0.0f;
                float min = elements[0, 0];
                for (int i = 0; i < elements.GetLength(0); i++)
                {
                    for (int j = 0; j < elements.GetLength(1); j++)
        ...
        /// <returns></returns>
        public static DenseMatrixf GetIdentity(uint dim)
        {
            ...
            for (int i = 0; i < dim; i++)
            {
                for (int j = 0; j < dim; j++)
                {
                    if (i != j) data[i, j] = 0.0f;
                    else data[i, j] = 1.0f;
                }
            }

            return new DenseMatrixf(data);
        }
        ...
        /// <param name="dim"></param>
        /// <returns></returns>
        public static DenseMatrixf GetZezo(uint dim)
        {
            return new DenseMatrixf(dim, dim);
        }
        ...
        /// Are near equal.
        /// </summary>
        public static bool NearEqual(DenseMatrixf m1, DenseMatrixf m2)
        {
        ...
        /// Are near equal.
        /// </summary>
        public static bool NearEqual(DenseMatrixf m1, DenseMatrixf m2, float eps)
        {
            if (m1.elements.GetLength(0) != m2.elements.GetLength(0) ||
               m1.elements.GetLength(1) != m2.elements.GetLength(1))
            {
        ...
        /// Adds two matrices.
        /// </summary>
        public static DenseMatrixf operator +([NotNull] DenseMatrixf m1, [NotNull] DenseMatrixf m2)
        {
        ...
        /// Negates matrix.
        /// </summary>
        public static DenseMatrixf operator -([NotNull] DenseMatrixf m2)
        {
        ...
        /// </summary>
        public static DenseMatrixf operator *([NotNull] DenseMatrixf m, float f)
        {
        ...
        /// Multiplication by scalar.
        /// </summary>
        public static DenseMatrixf operator *(float f, [NotNull] DenseMatrixf m)
        {
            return m * f;
        }
        ...
        public static DenseMatrixf operator *([NotNull] DenseMatrixf m1, [NotNull] DenseMatrixf m2)
        {
            ...
            DenseMatrixf m = new DenseMatrixf(m1.RowCount, m2.ColumnCount);
        ...
        /// </summary>
        public static Vectorf operator *([NotNull] Vectorf v, [NotNull] DenseMatrixf m)
        {
            if (v.DimensionCount != m.RowCount)
                throw new ArgumentException("Cannot transform vector because sizes do not match.");

            Vectorf res = new Vectorf(m.ColumnCount);
        ...
        {
            if (obj is DenseMatrixf) return Equals((DenseMatrixf)obj);
            return false;
        }
        ...
        #region ICloneable<DenseMatrixf> Members

        public DenseMatrixf Clone()
        {
            return new DenseMatrixf(elements.Clone() as float[,]);
        }

        #endregion

        #region IEquatable<DenseMatrixf> Members

        public bool Equals(DenseMatrixf other)
        {
        ...
        #region IDenseMatrixf<DenseMatrixf,DenseMatrixf> Members
        ...
        #region IMatrixBase<DenseMatrixf> Members

        public DenseMatrixf Inverse
        {
            get { return new DenseMatrixf(Algorithms.GaussJordan.Invert(elements)); }
        }
