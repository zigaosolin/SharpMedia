...
namespace SharpMedia.Components.Installation.Commands
{
    ...
    /// </summary>
    [Serializable]
    public class FailIfNotInstalled : ICommand
    {
        ...
        public FailIfNotInstalled() { }
        public FailIfNotInstalled(Guid[] installedPackages) { this.installedPackages = installedPackages; }
        public FailIfNotInstalled(Guid[] installedPackages, Guid[] installedApplications)
        {
