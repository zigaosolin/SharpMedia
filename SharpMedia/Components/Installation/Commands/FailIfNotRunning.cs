...
{
    /// <summary>
    /// Fails the install process if an application instance is not running
    /// </summary>
    [Serializable]
    public class FailIfNotRunning : ICommand
    {
        ...
        /// <summary>
        /// Applications that should be running at the time of the installation
        /// </summary>
        ...
        public FailIfNotRunning() { }
        public FailIfNotRunning(Guid appId) { this.applicationIds = new Guid[] { appId }; }
        public FailIfNotRunning(Guid[] appIds) { this.applicationIds = appIds; }
    }
}